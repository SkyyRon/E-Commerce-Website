...
function ContactUs() {
  return (
    <div>
        <NavBar/>
       <section className="bg-white -mt-10 dark:bg-white text-black">
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form action="#" className="space-y-8">
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-[#553939] sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-[#A05344] dark:hover:bg-[#553939] dark:focus:ring-primary-800">Send message</button>
      </form>
  </div>
</section>
