...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'tusarmanna2003@gmail.com', // gmail
    pass: 'pjmjiehkngwzbuyo', // pass
  },
});
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
                ...
                <img src="https://dakshinahawaresort.co.in/wp-content/uploads/2023/12/Lets_Shop-300x300.png" alt="Logo" border="0" width="48" style="display: block; width: 250px; max-width: 250px; min-width: 250px;">
              </a>
            </td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="tusarmanna2003@gmail.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
